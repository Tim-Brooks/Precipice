...
//    @Mock
//    private Pattern<Status, Rejected,  ThreadPoolService> pattern;
//    @Mock
...
//
//        when(service1.guardRail()).thenReturn(controller1);
//        when(service2.guardRail()).thenReturn(controller2);
//        when(service3.guardRail()).thenReturn(controller3);
...
//        when(controller.getRejectedMetrics()).thenReturn(metrics);
