...
public class SingleIncrementLatency<T extends Enum<T>> extends AbstractMetrics<T> implements WritableLatency<T> {
    ...
    public SingleIncrementLatency(WritableLatency<T> wrappedLatency) {
        super(wrappedLatency.getMetricClazz());
        this.wrappedLatency = wrappedLatency;
    }
