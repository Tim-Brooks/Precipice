...
public class NewGuardRail<Result extends Enum<Result> & Failable, Rejected extends Enum<Rejected>> {
    ...
    public NewGuardRail(String name, TotalCountMetrics<Result> resultMetrics, TotalCountMetrics<Rejected> rejectedMetrics,
