...
public class OldGuardRail<Result extends Enum<Result> & Failable, Rejected extends Enum<Rejected>> {
    ...
    public OldGuardRail(String name, TotalCountMetrics<Result> resultMetrics, TotalCountMetrics<Rejected> rejectedMetrics,
